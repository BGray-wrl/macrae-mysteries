...
// MAINTENANCE PAGE — uncomment the return below and comment out the main return to enable
export default function Home() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-gray-950 text-center px-8">
      <h1 className="text-4xl font-bold text-white mb-4">Site Under Maintenance</h1>
      <p className="text-gray-400 text-lg">We&apos;ll be back shortly. Thank you for your patience.</p>
    </div>
  );
}
